...
from greenlake-data-services.models.telemetry_status import TelemetryStatus  # noqa: E501
...
class TestTelemetryStatus(unittest.TestCase):
    ...
    def testTelemetryStatus(self):
        ...
        # model = greenlake-data-services.models.telemetry_status.TelemetryStatus()  # noqa: E501
        pass
