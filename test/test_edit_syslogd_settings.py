...
from greenlake-data-services.models.edit_syslogd_settings import EditSyslogdSettings  # noqa: E501
...
class TestEditSyslogdSettings(unittest.TestCase):
    ...
    def testEditSyslogdSettings(self):
        ...
        # model = greenlake-data-services.models.edit_syslogd_settings.EditSyslogdSettings()  # noqa: E501
        pass
