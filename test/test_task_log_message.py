...
from greenlake-data-services.models.task_log_message import TaskLogMessage  # noqa: E501
...
class TestTaskLogMessage(unittest.TestCase):
    ...
    def testTaskLogMessage(self):
        ...
        # model = greenlake-data-services.models.task_log_message.TaskLogMessage()  # noqa: E501
        pass
