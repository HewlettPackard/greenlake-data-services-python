...
from greenlake-data-services.models.volume_set_proximity_settings import VolumeSetProximitySettings  # noqa: E501
...
class TestVolumeSetProximitySettings(unittest.TestCase):
    ...
    def testVolumeSetProximitySettings(self):
        ...
        # model = greenlake-data-services.models.volume_set_proximity_settings.VolumeSetProximitySettings()  # noqa: E501
        pass
