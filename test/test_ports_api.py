...
from greenlake-data-services.api.ports_api import PortsApi  # noqa: E501
...
class TestPortsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = greenlake-data-services.api.ports_api.PortsApi()  # noqa: E501
    ...
    def test_device_type2_get_all_fibre_channel_configs(self):
    ...
    def test_device_type2_get_fibre_channel_config_by_id(self):
