...
from greenlake-data-services.models.node_mcus_summary_list import NodeMcusSummaryList  # noqa: E501
...
class TestNodeMcusSummaryList(unittest.TestCase):
    ...
    def testNodeMcusSummaryList(self):
        ...
        # model = greenlake-data-services.models.node_mcus_summary_list.NodeMcusSummaryList()  # noqa: E501
        pass
