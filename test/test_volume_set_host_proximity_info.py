...
from greenlake-data-services.models.volume_set_host_proximity_info import VolumeSetHostProximityInfo  # noqa: E501
...
class TestVolumeSetHostProximityInfo(unittest.TestCase):
    ...
    def testVolumeSetHostProximityInfo(self):
        ...
        # model = greenlake-data-services.models.volume_set_host_proximity_info.VolumeSetHostProximityInfo()  # noqa: E501
        pass
