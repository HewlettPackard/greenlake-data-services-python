...
from greenlake-data-services.models.collection_status import CollectionStatus  # noqa: E501
...
class TestCollectionStatus(unittest.TestCase):
    ...
    def testCollectionStatus(self):
        ...
        # model = greenlake-data-services.models.collection_status.CollectionStatus()  # noqa: E501
        pass
