# greenlake_data_services.HostPathsApi
...
> PrimeraHostPathList device_type1_get_all_host_paths(system_id)
...
from greenlake_data_services.api import host_paths_api
...
with greenlake_data_services.ApiClient(configuration) as api_client:
    ...
    api_instance = host_paths_api.HostPathsApi(api_client)
    ...
    try:
        # Get details of Primera / Alletra 9K Host Paths
        api_response = api_instance.device_type1_get_all_host_paths(system_id)
        pprint(api_response)
...
> PrimeraHostPaths device_type1_get_host_paths_by_id(system_id, host_path_id)
...
with greenlake_data_services.ApiClient(configuration) as api_client:
    ...
    try:
        # Get details of Primera / Alletra 9K Host Path identified by {HostPathId}
        api_response = api_instance.device_type1_get_host_paths_by_id(system_id, host_path_id)
        pprint(api_response)
    except greenlake_data_services.ApiException as e:
