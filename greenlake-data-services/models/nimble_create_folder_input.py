...
class NimbleCreateFolderInput(object):
    ...
    def __init__(self, access_protocol=None, agent_type=None, appserver_id=None, description=None, inherited_vol_perfpol_id=None, limit_iops=None, limit_mbps=None, limit_size_bytes=None, name=None, overdraft_limit_pct=None, pool_id=None, provisioned_limit_size_bytes=None):  # noqa: E501
        """NimbleCreateFolderInput - a model defined in OpenAPI"""  # noqa: E501
    ...
    def access_protocol(self):
        """Gets the access_protocol of this NimbleCreateFolderInput.  # noqa: E501
        ...
        :return: The access_protocol of this NimbleCreateFolderInput.  # noqa: E501
        :rtype: str
        """
    ...
    def access_protocol(self, access_protocol):
        """Sets the access_protocol of this NimbleCreateFolderInput.

        Access protocol of the folder. This attribute is used by the VASA Provider to determine the access protocol of the bind request. If not specified in the creation request, it will be the access protocol supported by the group. If the group supports multiple protocols, the default will be Fibre Channel. This field is meaningful only to VVol folder. Possible values: 'iscsi', 'fc'.  # noqa: E501

        :param access_protocol: The access_protocol of this NimbleCreateFolderInput.  # noqa: E501
        :type: str
        """
    ...
    @property
    def agent_type(self):
        """Gets the agent_type of this NimbleCreateFolderInput.  # noqa: E501

        External management agent type. Possible values: 'none', 'smis', 'vvol', 'openstack'.  # noqa: E501

        :return: The agent_type of this NimbleCreateFolderInput.  # noqa: E501
        :rtype: str
        """
    ...
    def agent_type(self, agent_type):
        """Sets the agent_type of this NimbleCreateFolderInput.

        External management agent type. Possible values: 'none', 'smis', 'vvol', 'openstack'.  # noqa: E501

        :param agent_type: The agent_type of this NimbleCreateFolderInput.  # noqa: E501
        :type: str
        """
    ...
    def appserver_id(self):
        """Gets the appserver_id of this NimbleCreateFolderInput.  # noqa: E501

        Identifier of the application server associated with the folder.  # noqa: E501

        :return: The appserver_id of this NimbleCreateFolderInput.  # noqa: E501
        :rtype: str
        """
    ...
    def appserver_id(self, appserver_id):
        """Sets the appserver_id of this NimbleCreateFolderInput.

        Identifier of the application server associated with the folder.  # noqa: E501

        :param appserver_id: The appserver_id of this NimbleCreateFolderInput.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this NimbleCreateFolderInput.  # noqa: E501

        Text description of folder.  # noqa: E501

        :return: The description of this NimbleCreateFolderInput.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this NimbleCreateFolderInput.

        Text description of folder.  # noqa: E501

        :param description: The description of this NimbleCreateFolderInput.  # noqa: E501
        :type: str
        """
    ...
    def inherited_vol_perfpol_id(self):
        """Gets the inherited_vol_perfpol_id of this NimbleCreateFolderInput.  # noqa: E501

        Identifier of the default performance policy for a newly created volume.  # noqa: E501

        :return: The inherited_vol_perfpol_id of this NimbleCreateFolderInput.  # noqa: E501
        :rtype: str
        """
    ...
    def inherited_vol_perfpol_id(self, inherited_vol_perfpol_id):
        """Sets the inherited_vol_perfpol_id of this NimbleCreateFolderInput.

        Identifier of the default performance policy for a newly created volume.  # noqa: E501

        :param inherited_vol_perfpol_id: The inherited_vol_perfpol_id of this NimbleCreateFolderInput.  # noqa: E501
        :type: str
        """
    ...
    @property
    def limit_iops(self):
        """Gets the limit_iops of this NimbleCreateFolderInput.  # noqa: E501
        ...
        :return: The limit_iops of this NimbleCreateFolderInput.  # noqa: E501
        :rtype: int
        """
    ...
    def limit_iops(self, limit_iops):
        """Sets the limit_iops of this NimbleCreateFolderInput.

        IOPS limit for this folder. If limit_iops is not specified when a folder is created, or if limit_iops is set to -1, then the folder has no IOPS limit. IOPS limit should be in range [256, 4294967294] or -1 for unlimited.  # noqa: E501

        :param limit_iops: The limit_iops of this NimbleCreateFolderInput.  # noqa: E501
        :type: int
        """
    ...
    @property
    def limit_mbps(self):
        """Gets the limit_mbps of this NimbleCreateFolderInput.  # noqa: E501
        ...
        :return: The limit_mbps of this NimbleCreateFolderInput.  # noqa: E501
        :rtype: int
        """
    ...
    def limit_mbps(self, limit_mbps):
        """Sets the limit_mbps of this NimbleCreateFolderInput.

        Throughput limit for this folder in MB/s. If limit_mbps is not specified when a folder is created, or if limit_mbps is set to -1, then the folder has no throughput limit. MBPS limit should be in range [1, 4294967294] or -1 for unlimited.  # noqa: E501

        :param limit_mbps: The limit_mbps of this NimbleCreateFolderInput.  # noqa: E501
        :type: int
        """
    ...
    def limit_size_bytes(self):
        """Gets the limit_size_bytes of this NimbleCreateFolderInput.  # noqa: E501
        ...
        :return: The limit_size_bytes of this NimbleCreateFolderInput.  # noqa: E501
        :rtype: int
        """
    ...
    def limit_size_bytes(self, limit_size_bytes):
        """Sets the limit_size_bytes of this NimbleCreateFolderInput.

        Folder size limit in bytes. If limit_size_bytes is not specified when a folder is created, or if limit_size_bytes is set to -1, then the folder has no limit. Otherwise, a limit smaller than the capacity of the pool can be set. Folders with an agent_type of 'smis' or 'vvol' must have a size limit.  # noqa: E501

        :param limit_size_bytes: The limit_size_bytes of this NimbleCreateFolderInput.  # noqa: E501
        :type: int
        """
    ...
    @property
    def name(self):
        """Gets the name of this NimbleCreateFolderInput.  # noqa: E501

        Name of the folder.  # noqa: E501

        :return: The name of this NimbleCreateFolderInput.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this NimbleCreateFolderInput.

        Name of the folder.  # noqa: E501

        :param name: The name of this NimbleCreateFolderInput.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def overdraft_limit_pct(self):
        """Gets the overdraft_limit_pct of this NimbleCreateFolderInput.  # noqa: E501
        ...
        :return: The overdraft_limit_pct of this NimbleCreateFolderInput.  # noqa: E501
        :rtype: int
        """
    ...
    def overdraft_limit_pct(self, overdraft_limit_pct):
        """Sets the overdraft_limit_pct of this NimbleCreateFolderInput.

        Amount of space to consider as overdraft range for this folder as a percentage of folder used limit. Valid values are from 0% - 200%. This is the limit above the folder usage limit beyond which enforcement action(volume offline/non-writable) is issued.  # noqa: E501

        :param overdraft_limit_pct: The overdraft_limit_pct of this NimbleCreateFolderInput.  # noqa: E501
        :type: int
        """
    ...
    @property
    def pool_id(self):
        """Gets the pool_id of this NimbleCreateFolderInput.  # noqa: E501

        ID of the pool where the folder resides.  # noqa: E501

        :return: The pool_id of this NimbleCreateFolderInput.  # noqa: E501
        :rtype: str
        """
    ...
    def pool_id(self, pool_id):
        """Sets the pool_id of this NimbleCreateFolderInput.

        ID of the pool where the folder resides.  # noqa: E501

        :param pool_id: The pool_id of this NimbleCreateFolderInput.  # noqa: E501
        :type: str
        """
        if pool_id is None:
    ...
    def provisioned_limit_size_bytes(self):
        """Gets the provisioned_limit_size_bytes of this NimbleCreateFolderInput.  # noqa: E501
        ...
        :return: The provisioned_limit_size_bytes of this NimbleCreateFolderInput.  # noqa: E501
        :rtype: int
        """
    ...
    def provisioned_limit_size_bytes(self, provisioned_limit_size_bytes):
        """Sets the provisioned_limit_size_bytes of this NimbleCreateFolderInput.

        Limit on the provisioned size of volumes in a folder. If provisioned_limit_size_bytes is not specified when a folder is created, or if provisioned_limit_size_bytes is set to -1, then the folder has no provisioned size limit.  # noqa: E501

        :param provisioned_limit_size_bytes: The provisioned_limit_size_bytes of this NimbleCreateFolderInput.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NimbleCreateFolderInput):
            return False
