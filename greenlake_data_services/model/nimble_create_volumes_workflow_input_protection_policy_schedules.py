...
class NimbleCreateVolumesWorkflowInputProtectionPolicySchedules(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NimbleCreateVolumesWorkflowInputProtectionPolicySchedules - a model defined in OpenAPI
