...
class NimbleCreateFolderInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, pool_id, *args, **kwargs):  # noqa: E501
        """NimbleCreateFolderInput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, pool_id, *args, **kwargs):  # noqa: E501
        """NimbleCreateFolderInput - a model defined in OpenAPI
