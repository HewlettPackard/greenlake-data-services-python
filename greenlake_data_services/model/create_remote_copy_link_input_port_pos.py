...
class CreateRemoteCopyLinkInputPortPos(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, node, port, slot, *args, **kwargs):  # noqa: E501
        """CreateRemoteCopyLinkInputPortPos - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, node, port, slot, *args, **kwargs):  # noqa: E501
        """CreateRemoteCopyLinkInputPortPos - a model defined in OpenAPI
