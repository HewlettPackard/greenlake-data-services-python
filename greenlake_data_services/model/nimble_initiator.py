...
class NimbleInitiator(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NimbleInitiator - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            access_protocol (str, none_type): Access protocol used by the initiator. Possible values: 'iscsi', 'fc'. `Filter, Sort`. [optional]  # noqa: E501
            alias (str, none_type): Alias of the Fibre Channel initiator. Maximum alias length is 32 characters. Each initiator alias must have an associated WWPN specified using the 'wwpn' attribute.You can choose not to enter the WWPN for an initiator when using previously saved initiator alias.String of up to 32 alphanumeric characters, or one of $^-_.: cannot begin with non-alphanumeric character.`Filter, Sort`. [optional]  # noqa: E501
            associated_links (AssociatedLinks): [optional]  # noqa: E501
            chapuser_id (str, none_type): Identifier for the CHAP user.`Filter, Sort`. [optional]  # noqa: E501
            ...
            id (str, none_type): Identifier for initiator. A 42 digit hexadecimal number. `Filter`. [optional]  # noqa: E501
            initiator_group_id (str, none_type): Identifier of the initiator group that this initiator is assigned to. A 42 digit hexadecimal number. `Filter, Sort`. [optional]  # noqa: E501
            initiator_group_name (str, none_type): Name of the initiator group that this initiator is assigned to. String of up to 64 alphanumeric characters, - and . and : are allowed after first character `Filter, Sort`. [optional]  # noqa: E501
            ip_address (str, none_type): IP address of the iSCSI initiator. Each initiator IP address must have an associated name specified using 'name' attribute.You can choose not to enter the name for an initiator if you prefer not to authenticate using both name and IP address, in this case the IQN name will be returned as '*'. Alphanumeric, hyphenated, colon or period separated string of up to 255 characters or '*' `Filter, Sort`. [optional]  # noqa: E501
            iqn (str, none_type): IQN name of the iSCSI initiator. Each initiator IQN name must have an associated IP address specified using the 'ip_address' attribute.You can choose not to enter the IP address for an initiator if you prefer not to authenticate using both name and IP address,in this case the IP address will be returned as '*'. `Filter, Sort`. [optional]  # noqa: E501
            label (str, none_type): Unique Identifier of the iSCSI initiator. Label is required when creating iSCSI initiator. String of up to 64 alphanumeric characters, - and . and : are allowed after first character. `Filter, Sort`. [optional]  # noqa: E501
