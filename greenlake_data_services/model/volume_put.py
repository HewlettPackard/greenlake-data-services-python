...
class VolumePut(ModelNormal):
    ...
    allowed_values = {
        ('conversion_type',): {
            'None': None,
            'THIN': "CONVERSIONTYPE_THIN",
            'DDS': "CONVERSIONTYPE_DDS",
            'V1': "CONVERSIONTYPE_V1",
            'V2': "CONVERSIONTYPE_V2",
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'size_mib': (float, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VolumePut - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            conversion_type (str, none_type): conversion type (this argument is depricated, use dataReduction instead). [optional]  # noqa: E501
            data_reduction (bool, none_type): Data Reduction on Volume. [optional]  # noqa: E501
            name (str, none_type): volume name. [optional]  # noqa: E501
            size_mib (float, none_type): Size in MiB. [optional]  # noqa: E501
            snapshot_alloc_warning (int, none_type): snapshot alloc space allocation warning. [optional]  # noqa: E501
