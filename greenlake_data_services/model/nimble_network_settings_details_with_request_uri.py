...
class NimbleNetworkSettingsDetailsWithRequestUri(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NimbleNetworkSettingsDetailsWithRequestUri - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            request_uri (str, none_type): requestUri for detailed network setting object. [optional]  # noqa: E501
            id (str, none_type): Identifier for network settings.. [optional]  # noqa: E501
            name (str, none_type): Name of the network configuration. Possible values: 'active', 'backup', 'draft'. [optional]  # noqa: E501
            role (str, none_type): Role of network configuration. Possible values: 'active', 'backup', 'draft'. [optional]  # noqa: E501
