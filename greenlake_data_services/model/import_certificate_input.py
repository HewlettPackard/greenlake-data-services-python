...
class ImportCertificateInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, authority_chain, certificate, *args, **kwargs):  # noqa: E501
        """ImportCertificateInput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, authority_chain, certificate, *args, **kwargs):  # noqa: E501
        """ImportCertificateInput - a model defined in OpenAPI
