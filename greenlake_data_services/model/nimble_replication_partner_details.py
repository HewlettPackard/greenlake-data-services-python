...
class NimbleReplicationPartnerDetails(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NimbleReplicationPartnerDetails - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            array_serial (str, none_type): Serial number of group leader array of the partner. Plain string.. [optional]  # noqa: E501
            cfg_sync_status (str, none_type): Indicates whether all volumes and volume collections have been synced to the partner. Possible values: N/A, Yes, No. . [optional]  # noqa: E501
            creation_time (int, none_type): Time when this replication partner was created. Seconds since last epoch i.e. 00:00 January 1, 1970.. [optional]  # noqa: E501
            folder_id (str, none_type): The Folder ID within the pool where volumes replicated from this partner will be created. This is not supported for pool partners. A 42 digit hexadecimal number. . [optional]  # noqa: E501
            folder_name (str, none_type): The Folder name within the pool where volumes replicated from this partner will be created. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.. [optional]  # noqa: E501
            hostname (str, none_type): IP address or hostname of partner interface. This must be the partners Group Management IP address. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.. [optional]  # noqa: E501
            id (str, none_type): Identifier for a replication partner. A 42 digit hexadecimal number.. [optional]  # noqa: E501
            is_alive (bool, none_type): Whether the partner is available, and responding to pings. Possible values: true, false. [optional]  # noqa: E501
            name (str, none_type): Name of replication partner. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.. [optional]  # noqa: E501
            partner_type (str, none_type): Type of the partner, Possible values: 'group' or 'pool'. . [optional]  # noqa: E501
            paused (bool, none_type): Indicates whether replication traffic from/to this partner has been halted. Possible values: true, false. [optional]  # noqa: E501
            pool_id (str, none_type): The pool ID where volumes replicated from this partner will be created. Replica volumes created as clones ignore this parameter and are always created in the same pool as their parent volume. A 42 digit hexadecimal number.. [optional]  # noqa: E501
            pool_name (str, none_type): The pool name where volumes replicated from this partner will be created. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.. [optional]  # noqa: E501
            repl_hostname (str, none_type): IP address or hostname of partner data interface. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.. [optional]  # noqa: E501
            subnet_label (str, none_type): Label of the subnet used to replicate to this partner. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.. [optional]  # noqa: E501
            subnet_netmask (str, none_type): Subnet mask used to replicate to this partner. A netmask expressed as a 32 bit binary value must have the highest bit set (2^31) and the lowest bit clear (2^0) with the first zero followed by only zeros.. [optional]  # noqa: E501
            subnet_network (str, none_type): Subnet used to replicate to this partner. Four numbers in the range [0,255] separated by periods.. [optional]  # noqa: E501
            subnet_type (str, none_type): Type of the subnet used to replicate to this partner. Possible values: invalid, unconfigured, mgmt, data, mgmt_data. [optional]  # noqa: E501
            system_id (str, none_type): Identifier for a system or array. A 42 digit hexadecimal number.. [optional]  # noqa: E501
            version (int, none_type): Replication version of the partner. Signed 64-bit integer.. [optional]  # noqa: E501
            volume_collection_list_count (int, none_type): Count of volume collections that are replicating from/to this partner. Unsigned 64-bit integer.. [optional]  # noqa: E501
