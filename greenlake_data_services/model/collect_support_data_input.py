...
class CollectSupportDataInput(ModelNormal):
    ...
    allowed_values = {
        ('action',): {
            'None': None,
            'PERFCOLLECTION': "PERFCOLLECTION",
            'INSPLORECOLLECTION': "INSPLORECOLLECTION",
            'APPDUMPCOLLECTION': "APPDUMPCOLLECTION",
            'CRASHDUMPCOLLECTION': "CRASHDUMPCOLLECTION",
            'SPLORCOLLECTION': "SPLORCOLLECTION",
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CollectSupportDataInput - a model defined in OpenAPI
