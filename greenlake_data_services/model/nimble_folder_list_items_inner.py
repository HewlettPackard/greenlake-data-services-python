...
class NimbleFolderListItemsInner(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NimbleFolderListItemsInner - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str, none_type): Identifier of the folder. `Filter`. [optional]  # noqa: E501
            name (str, none_type): Name of the folder. `Filter, Sort`. [optional]  # noqa: E501
            pool_id (str, none_type): ID of the pool where the folder resides.`Filter, Sort`. [optional]  # noqa: E501
            pool_name (str, none_type): Name of the pool where the folder resides.`Filter, Sort`. [optional]  # noqa: E501
