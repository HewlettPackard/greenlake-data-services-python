...
class NimbleCreateSnapshotInput(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        """NimbleCreateSnapshotInput - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            app_uuid (str, none_type): Application identifier of snapshots. String of up to 255 alphanumeric characters, hyphen, colon, dot and underscore are allowed. Defaults to empty string.. [optional]  # noqa: E501
            description (str, none_type): Text description of snapshot. String of up to 255 printable ASCII characters. Defaults to the empty string.. [optional]  # noqa: E501
            ...
            online (bool, none_type): Online state for a snapshot means it could be mounted for data restore. Defaults to 'false'.. [optional]  # noqa: E501
            writable (bool, none_type): Allow snapshot to be writable. Mandatory and must be set to 'true' for VSS application synchronized snapshots. Defaults to 'false'.. [optional]  # noqa: E501
        """
