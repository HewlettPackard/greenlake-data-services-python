...
class NimbleSnapshotCollectionDetails(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'online_status': (str, none_type,),  # noqa: E501
            'schedule_id': (str, none_type,),  # noqa: E501
            'srep_owner_id': (str, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'srep_owner_id': 'srep_owner_id',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NimbleSnapshotCollectionDetails - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str, none_type): Identifier for the snapshot collection. A 42 digit hexadecimal number. `Filter`. [optional]  # noqa: E501
            ...
            online_status (str, none_type): Online status of snapshot collection. This is based on the online status of the individual snapshots. Online status based on that of the constituent entities. Possible values: 'online', 'offline' or 'partial'.. [optional]  # noqa: E501
            schedule_id (str, none_type): Identifier of protection schedule. A 42 digit hexadecimal number. `Filter, Sort`. [optional]  # noqa: E501
            srep_owner_id (str, none_type): ID of the partner where snapshots for this snapshot collection reside which were created by synchronous replication. Field will be null if no peer snapshot_collection was created by synchronous replication. A 42 digit hexadecimal number. `Filter, Sort`. [optional]  # noqa: E501
            volcoll_id (str, none_type): Parent volume collection ID. A 42 digit hexadecimal number. `Filter, Sort`. [optional]  # noqa: E501
