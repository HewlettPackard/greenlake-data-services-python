...
class NimbleAccessControlRecordDetailsWithRequestUri(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NimbleAccessControlRecordDetailsWithRequestUri - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            request_uri (str, none_type): requestUri for detailed access-control-record object. [optional]  # noqa: E501
            access_protocol (str, none_type): Access protocol of the volume. Possible values:'iscsi', 'fc'.. [optional]  # noqa: E501
            chap_user_id (str, none_type): Identifier for the CHAP user.. [optional]  # noqa: E501
            chap_user_name (str, none_type): Flag denoting if data in the associated volume should be compressed.. [optional]  # noqa: E501
            creation_time (int, none_type): Time when this access control record was created.. [optional]  # noqa: E501
            id (str, none_type): Identifier for the access control record.. [optional]  # noqa: E501
            initiator_group_id (str, none_type): Identifier for the initiator group.. [optional]  # noqa: E501
            initiator_group_name (str, none_type): Name of the initiator group.. [optional]  # noqa: E501
            last_modified (int, none_type): Time when this access control record was last modified.. [optional]  # noqa: E501
            lun (int, none_type): If this access control record applies to a regular volume, this attribute is the volume's LUN (Logical Unit Number). If the access protocol is iSCSI, the LUN will be 0. However, if the access protocol is Fibre Channel, the LUN will be in the range from 0 to 2047. If this record applies to a Virtual Volume, this attribute is the volume's secondary LUN in the range from 0 to 399999, for both iSCSI and Fibre Channel. If the record applies to a OpenstackV2 volume, the LUN will be in the range from 0 to 2047, for both iSCSI and Fibre Channel. If this record applies to a protocol endpoint or only a snapshot, this attribute is not meaningful and is set to null.. [optional]  # noqa: E501
            pe_id (str, none_type): Identifier for the protocol endpoint this access control record applies to.. [optional]  # noqa: E501
            pe_lun (int, none_type): LUN (Logical Unit Number) to associate with this protocol endpoint. Valid LUNs are in the 0-2047 range.. [optional]  # noqa: E501
            pe_name (str, none_type): Name of the protocol endpoint this access control record applies to.. [optional]  # noqa: E501
            snap_id (str, none_type): Identifier for the snapshot this access control record applies to.. [optional]  # noqa: E501
            snap_name (str, none_type): Name of the snapshot this access control record applies to.. [optional]  # noqa: E501
            vol_id (str, none_type): Identifier for the volume this access control record applies to.. [optional]  # noqa: E501
            vol_name (str, none_type): Name of the volume this access control record applies to.. [optional]  # noqa: E501
