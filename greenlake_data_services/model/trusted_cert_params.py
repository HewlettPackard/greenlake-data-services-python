...
class TrustedCertParams(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, certificates, type, *args, **kwargs):  # noqa: E501
        """TrustedCertParams - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, certificates, type, *args, **kwargs):  # noqa: E501
        """TrustedCertParams - a model defined in OpenAPI
