...
class NimbleVCollectionDetailsWithRequestUri(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NimbleVCollectionDetailsWithRequestUri - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            app_cluster_name (str, none_type): If the application is running within a Windows cluster environment, this is the cluster name.. [optional]  # noqa: E501
            app_id (str, none_type): Application ID running on the server. Application ID can only be specified if application synchronization is \\\\\"vss\\\\\".  Possible values: 'exchange_dag', 'sql2012', 'inval', 'sql2014', 'sql2005', 'sql2016', 'exchange', 'sql2017', 'sql2018', 'hyperv'.. [optional]  # noqa: E501
            ...
            id (str, none_type): Identifier of the Volume-Collection.. [optional]  # noqa: E501
            name (str, none_type): Name of volume collection.. [optional]  # noqa: E501
            prottmpl_id (str, none_type): Identifier of the protection template whose attributes will be used to create this volume collection. This attribute is only used for input when creating a volume collection and is not outputed.. [optional]  # noqa: E501
            replication_type (str, none_type): Type of replication configured for the volume collection. Possible values: 'synchronous', 'periodic_snapshot'.. [optional]  # noqa: E501
            synchronous_replication_state (str, none_type): State of synchronous replication on the volume collection. Possible values: 'in_sync', 'not_applicable', 'out_of_sync', 'unknown'.. [optional]  # noqa: E501
            synchronous_replication_type (str, none_type): Type of synchronous replication configured for the volume collection. Possible values: 'soft_available', 'not_applicable'.. [optional]  # noqa: E501
