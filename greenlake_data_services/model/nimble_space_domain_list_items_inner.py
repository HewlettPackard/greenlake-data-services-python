...
class NimbleSpaceDomainListItemsInner(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NimbleSpaceDomainListItemsInner - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            app_category_id (str, none_type): Identifier of the application category associated with the space domain. `Filter`. [optional]  # noqa: E501
            app_category_name (str, none_type): Name of the application category associated with the space domain. `Filter`. [optional]  # noqa: E501
            block_size (int, none_type): Block size in bytes of volumes belonging to the space domain. `Sort`. [optional]  # noqa: E501
            clone_ratio (float, none_type): Clone savings for the space domain expressed as ratio. `Sort`. [optional]  # noqa: E501
            compressed_usage_bytes (int, none_type): Compressed usage of volumes and snapshots in the space domain. `Sort`. [optional]  # noqa: E501
            compression_ratio (float, none_type): Compression savings for the space domain expressed as ratio. `Sort`. [optional]  # noqa: E501
            dedupe_ratio (float, none_type): Deduplication savings for the space domain expressed as ratio. `Sort`. [optional]  # noqa: E501
            deduped (bool, none_type): Volumes in space domain are deduplicated by default. `Filter, Sort`. [optional]  # noqa: E501
            encrypted (bool, none_type): Volumes in space domain are encrypted. `Filter, Sort`. [optional]  # noqa: E501
            id (str, none_type): Identifier of the application summery. `Filter`. [optional]  # noqa: E501
            logical_dedupe_usage (int, none_type): Logical space usage of volumes when deduped. `Sort`. [optional]  # noqa: E501
            physical_dedupe_usage (int, none_type): Physical space usage of volumes including snapshots when deduped. `Sort`. [optional]  # noqa: E501
            pool_id (str, none_type): Identifier associated with the pool in the storage pool table. `Filter`. [optional]  # noqa: E501
            pool_name (str, none_type): Name of the pool containing the space domain. `Filter`. [optional]  # noqa: E501
            savings_clone (int, none_type): Space usage savings in the space domain due to cloning of volumes. `Sort`. [optional]  # noqa: E501
            savings_compression (int, none_type): Space usage savings in the space domain due to compression. `Sort`. [optional]  # noqa: E501
            savings_dedupe (int, none_type): Space usage savings in the space domain due to deduplication. `Sort`. [optional]  # noqa: E501
            snap_logical_usage (int, none_type): Logical usage of snapshots in the space domain. `Sort`. [optional]  # noqa: E501
            uncompressed_usage_bytes (int, none_type): Uncompressed usage of volumes and snapshots in the space domain. `Sort`. [optional]  # noqa: E501
            usage (int, none_type): Physical space usage of volumes in the space domain. `Sort`. [optional]  # noqa: E501
            vol_logical_usage (int, none_type): Logical usage of volumes in the space domain. `Sort`. [optional]  # noqa: E501
            vol_mapped_usage (int, none_type): Mapped usage of volumes in the space domain, useful for computing clone savings. `Sort`. [optional]  # noqa: E501
