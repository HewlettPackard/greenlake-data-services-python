...
class NimblePoolsListItemsInner(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NimblePoolsListItemsInner - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (str, none_type): Identifier of pool. A 42 digit hexadecimal number. `Filter`. [optional]  # noqa: E501
            name (str, none_type): Name of pool. String of up to 64 alphanumeric characters, - and . and : are allowed after first character. `Filter, Sort`. [optional]  # noqa: E501
