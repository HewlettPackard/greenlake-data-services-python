...
class NimbleShelfLocateInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cid, status, *args, **kwargs):  # noqa: E501
        """NimbleShelfLocateInput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, cid, status, *args, **kwargs):  # noqa: E501
        """NimbleShelfLocateInput - a model defined in OpenAPI
