...
class NimbleVolumeDetails(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NimbleVolumeDetails - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            request_uri (str, none_type): requestUri for detailed volume objects. [optional]  # noqa: E501
            base_snap_id (str, none_type): Base snapshot ID. This attribute is required together with name and clone when cloning a volume with the create operation. A 42 digit hexadecimal number.. [optional]  # noqa: E501
            ...
            clone (bool, none_type): Whether this volume is a clone. Use this attribute in combination with name and base_snap_id to create a clone by setting clone = true.. [optional]  # noqa: E501
            dest_pool_id (str, none_type): ID of the destination pool where the volume is moving to. A 42 digit hexadecimal number.. [optional]  # noqa: E501
            dest_pool_name (str, none_type): Name of the destination pool where the volume is moving to. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.. [optional]  # noqa: E501
            folder_id (str, none_type): ID of the folder holding this volume. An optional NsObjectID. A 42 digit hexadecimal number or the empty string.. [optional]  # noqa: E501
            folder_name (str, none_type): Name of the folder holding this volume. It can be empty. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.. [optional]  # noqa: E501
            id (str, none_type): Identifier for the volume. A 42 digit hexadecimal number.. [optional]  # noqa: E501
            name (str, none_type): Name of the volume. String of up to 215 alphanumeric, hyphenated, colon, or period-separated characters; but cannot begin with hyphen, colon or period.. [optional]  # noqa: E501
            online (bool, none_type): Online state of volume, available for host initiators to establish connections.. [optional]  # noqa: E501
            owned_by_group (str, none_type): Name of group that currently owns the volume. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.. [optional]  # noqa: E501
            owned_by_group_id (str, none_type): ID of group that currently owns the volume. A 42 digit hexadecimal number.. [optional]  # noqa: E501
            parent_vol_id (str, none_type): Parent volume ID. A 42 digit hexadecimal number.. [optional]  # noqa: E501
            parent_vol_name (str, none_type): Name of parent volume. String of up to 215 alphanumeric, hyphenated, colon, or period-separated characters; but cannot begin with hyphen, colon or period. This type is used for object sets containing volumes, snapshots, snapshot collections and protocol endpoints.. [optional]  # noqa: E501
            perfpolicy_id (str, none_type): Identifier of the performance policy. After creating a volume, performance policy for the volume can only be changed to another performance policy with same block size. A 42 digit hexadecimal number.. [optional]  # noqa: E501
            perfpolicy_name (str, none_type): Name of performance policy. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.. [optional]  # noqa: E501
            pool_id (str, none_type): Identifier associated with the pool in the storage pool table. A 42 digit hexadecimal number.. [optional]  # noqa: E501
            ...
            read_only (bool, none_type): Volume is read-only.. [optional]  # noqa: E501
            replication_role (str, none_type): Replication role that this volume performs. Possible values: 'periodic_snapshot_downstream', 'synchronous_upstream', 'synchronous_downstream', 'no_replication', 'periodic_snapshot_upstream'.. [optional]  # noqa: E501
            secondary_serial_number (str, none_type): Secondary identifier associated with the volume for the SCSI protocol.. [optional]  # noqa: E501
            serial_number (str, none_type): Identifier associated with the volume for the SCSI protocol. A 32 digit hexadecimal number.. [optional]  # noqa: E501
            size (int, none_type): Volume size in megabytes. Size is required for creating a volume but not for cloning an existing volume.. [optional]  # noqa: E501
            target_name (str, none_type): The iSCSI Qualified Name (IQN) or the Fibre Channel World Wide Node Name (WWNN) of the target volume. The iSCSI Qualified Name (IQN) or the Fibre Channel World Wide Node Name (WWNN) of the target.. [optional]  # noqa: E501
            ...
            volcoll_name (str, none_type): Name of volume collection of which this volume is a member. String of up to 64 alphanumeric characters, - and . and : are allowed after first character.. [optional]  # noqa: E501
