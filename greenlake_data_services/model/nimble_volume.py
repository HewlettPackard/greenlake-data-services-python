...
def lazy_import():
    ...
    globals()['NimbleVolumeFilterableFields'] = NimbleVolumeFilterableFields
    globals()['SnapSummary'] = SnapSummary
    globals()['SnapshotFromVolume'] = SnapshotFromVolume


class NimbleVolume(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'base_snap_id': (str, none_type,),  # noqa: E501
            'base_snap_name': (str, none_type,),  # noqa: E501
            'clone': (bool, none_type,),  # noqa: E501
            'dest_pool_id': (str, none_type,),  # noqa: E501
            'dest_pool_name': (str, none_type,),  # noqa: E501
            'folder_id': (str, none_type,),  # noqa: E501
            'folder_name': (str, none_type,),  # noqa: E501
            'id': (str, none_type,),  # noqa: E501
            'name': (str, none_type,),  # noqa: E501
            'online': (bool, none_type,),  # noqa: E501
            'owned_by_group': (str, none_type,),  # noqa: E501
            'owned_by_group_id': (str, none_type,),  # noqa: E501
            'parent_vol_id': (str, none_type,),  # noqa: E501
            'parent_vol_name': (str, none_type,),  # noqa: E501
            'perfpolicy_id': (str, none_type,),  # noqa: E501
            'perfpolicy_name': (str, none_type,),  # noqa: E501
            'pool_id': (str, none_type,),  # noqa: E501
            'pool_name': (str, none_type,),  # noqa: E501
            'read_only': (bool, none_type,),  # noqa: E501
            'replication_role': (str, none_type,),  # noqa: E501
            'secondary_serial_number': (str, none_type,),  # noqa: E501
            'serial_number': (str, none_type,),  # noqa: E501
            'size': (int, none_type,),  # noqa: E501
            'target_name': (str, none_type,),  # noqa: E501
            'volcoll_id': (str, none_type,),  # noqa: E501
            'volcoll_name': (str, none_type,),  # noqa: E501
    ...
    attribute_map = {
        'base_snap_id': 'base_snap_id',  # noqa: E501
        'base_snap_name': 'base_snap_name',  # noqa: E501
        'clone': 'clone',  # noqa: E501
        'dest_pool_id': 'dest_pool_id',  # noqa: E501
        'dest_pool_name': 'dest_pool_name',  # noqa: E501
        'folder_id': 'folder_id',  # noqa: E501
        'folder_name': 'folder_name',  # noqa: E501
        'id': 'id',  # noqa: E501
        'name': 'name',  # noqa: E501
        'online': 'online',  # noqa: E501
        'owned_by_group': 'owned_by_group',  # noqa: E501
        'owned_by_group_id': 'owned_by_group_id',  # noqa: E501
        'parent_vol_id': 'parent_vol_id',  # noqa: E501
        'parent_vol_name': 'parent_vol_name',  # noqa: E501
        'perfpolicy_id': 'perfpolicy_id',  # noqa: E501
        'perfpolicy_name': 'perfpolicy_name',  # noqa: E501
        'pool_id': 'pool_id',  # noqa: E501
        'pool_name': 'pool_name',  # noqa: E501
        'read_only': 'read_only',  # noqa: E501
        'replication_role': 'replication_role',  # noqa: E501
        'secondary_serial_number': 'secondary_serial_number',  # noqa: E501
        'serial_number': 'serial_number',  # noqa: E501
        'size': 'size',  # noqa: E501
        'target_name': 'target_name',  # noqa: E501
        'volcoll_id': 'volcoll_id',  # noqa: E501
        'volcoll_name': 'volcoll_name',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NimbleVolume - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            base_snap_id (str, none_type): Base snapshot ID. This attribute is required together with name and clone when cloning a volume with the create operation. A 42 digit hexadecimal number. `Filter, Sort`. [optional]  # noqa: E501
            ...
            clone (bool, none_type): Whether this volume is a clone. Use this attribute in combination with name and base_snap_id to create a clone by setting clone = true. `Filter, Sort`. [optional]  # noqa: E501
            dest_pool_id (str, none_type): ID of the destination pool where the volume is moving to. A 42 digit hexadecimal number. `Filter, Sort`. [optional]  # noqa: E501
            dest_pool_name (str, none_type): Name of the destination pool where the volume is moving to. String of up to 64 alphanumeric characters, - and . and : are allowed after first character. `Filter, Sort`. [optional]  # noqa: E501
            folder_id (str, none_type): ID of the folder holding this volume. An optional NsObjectID. A 42 digit hexadecimal number or the empty string. `Filter, Sort`. [optional]  # noqa: E501
            folder_name (str, none_type): Name of the folder holding this volume. It can be empty. String of up to 64 alphanumeric characters, - and . and : are allowed after first character. `Filter, Sort`. [optional]  # noqa: E501
            id (str, none_type): Identifier for the volume. A 42 digit hexadecimal number. `Filter`. [optional]  # noqa: E501
            name (str, none_type): Name of the volume. String of up to 215 alphanumeric, hyphenated, colon, or period-separated characters; but cannot begin with hyphen, colon or period. `Filter, Sort`. [optional]  # noqa: E501
            online (bool, none_type): Online state of volume, available for host initiators to establish connections. `Filter, Sort`. [optional]  # noqa: E501
            owned_by_group (str, none_type): Name of group that currently owns the volume. String of up to 64 alphanumeric characters, - and . and : are allowed after first character. `Filter, Sort`. [optional]  # noqa: E501
            owned_by_group_id (str, none_type): ID of group that currently owns the volume. A 42 digit hexadecimal number. `Filter, Sort`. [optional]  # noqa: E501
            parent_vol_id (str, none_type): Parent volume ID. A 42 digit hexadecimal number. `Filter, Sort`. [optional]  # noqa: E501
            parent_vol_name (str, none_type): Name of parent volume. String of up to 215 alphanumeric, hyphenated, colon, or period-separated characters; but cannot begin with hyphen, colon or period. This type is used for object sets containing volumes, snapshots, snapshot collections and protocol endpoints. `Filter, Sort`. [optional]  # noqa: E501
            perfpolicy_id (str, none_type): Identifier of the performance policy. After creating a volume, performance policy for the volume can only be changed to another performance policy with same block size. A 42 digit hexadecimal number. `Filter, Sort`. [optional]  # noqa: E501
            perfpolicy_name (str, none_type): Name of performance policy. String of up to 64 alphanumeric characters, - and . and : are allowed after first character. `Filter, Sort`. [optional]  # noqa: E501
            pool_id (str, none_type): Identifier associated with the pool in the storage pool table. A 42 digit hexadecimal number. `Filter, Sort`. [optional]  # noqa: E501
            pool_name (str, none_type): Name of the pool where the volume resides. Volume data will be distributed across arrays over which specified pool is defined. If pool option is not specified, volume is assigned to the default pool. String of up to 64 alphanumeric characters, - and . and : are allowed after first character. `Filter, Sort`. [optional]  # noqa: E501
            read_only (bool, none_type): Volume is read-only. `Filter, Sort`. [optional]  # noqa: E501
            replication_role (str, none_type): Replication role that this volume performs. Possible values: 'periodic_snapshot_downstream', 'synchronous_upstream', 'synchronous_downstream', 'no_replication', 'periodic_snapshot_upstream'. `Filter, Sort`. [optional]  # noqa: E501
            secondary_serial_number (str, none_type): Secondary identifier associated with the volume for the SCSI protocol. `Filter, Sort`. [optional]  # noqa: E501
            serial_number (str, none_type): Identifier associated with the volume for the SCSI protocol. A 32 digit hexadecimal number. `Filter, Sort`. [optional]  # noqa: E501
            size (int, none_type): Volume size in megabytes. Size is required for creating a volume but not for cloning an existing volume. `Filter, Sort`. [optional]  # noqa: E501
            target_name (str, none_type): The iSCSI Qualified Name (IQN) or the Fibre Channel World Wide Node Name (WWNN) of the target volume. The iSCSI Qualified Name (IQN) or the Fibre Channel World Wide Node Name (WWNN) of the target. `Filter, Sort`. [optional]  # noqa: E501
            volcoll_id (str, none_type): ID of volume collection of which this volume is a member. Use this attribute in update operation to associate or dissociate volumes with or from volume collections. When associating, set this attribute to the ID of the volume collection. When dissociating, set this attribute to empty string. An optional NsObjectID. A 42 digit hexadecimal number or the empty string. `Filter, Sort`. [optional]  # noqa: E501
            volcoll_name (str, none_type): Name of volume collection of which this volume is a member. String of up to 64 alphanumeric characters, - and . and : are allowed after first character. `Filter, Sort`. [optional]  # noqa: E501
