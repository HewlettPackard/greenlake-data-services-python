...
class PortsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.device_type2_get_all_fibre_channel_configs_endpoint = _Endpoint(
            settings={
                'response_type': (NimbleFCConfigsList,),
                'auth': [
                    'JWTAuth'
                ],
                'endpoint_path': '/api/v1/storage-systems/device-type2/{systemId}/fibre-channel-configs',
                'operation_id': 'device_type2_get_all_fibre_channel_configs',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.device_type2_get_fibre_channel_config_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (NimblefibreChannelConfigsWithRequestUri,),
                'auth': [
                    'JWTAuth'
                ],
                'endpoint_path': '/api/v1/storage-systems/device-type2/{systemId}/fibre-channel-configs/{fcConfigId}',
                'operation_id': 'device_type2_get_fibre_channel_config_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def device_type2_get_all_fibre_channel_configs(
        ...
        **kwargs
        ...
        >>> thread = api.device_type2_get_all_fibre_channel_configs(system_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['system_id'] = \
            system_id
        return self.device_type2_get_all_fibre_channel_configs_endpoint.call_with_http_info(**kwargs)
    ...
    def device_type2_get_fibre_channel_config_by_id(
        ...
        **kwargs
        ...
        >>> thread = api.device_type2_get_fibre_channel_config_by_id(system_id, fc_config_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['fc_config_id'] = \
            fc_config_id
        return self.device_type2_get_fibre_channel_config_by_id_endpoint.call_with_http_info(**kwargs)
