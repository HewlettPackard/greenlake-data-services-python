...
class HostSetsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.device_type1_get_all_host_sets_endpoint = _Endpoint(
            settings={
                'response_type': (PrimeraHostSetList,),
                'auth': [
                    'JWTAuth'
                ],
                'endpoint_path': '/api/v1/storage-systems/device-type1/{systemId}/host-sets',
                'operation_id': 'device_type1_get_all_host_sets',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.device_type1_get_host_sets_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (PrimeraHostSets,),
                'auth': [
                    'JWTAuth'
                ],
                'endpoint_path': '/api/v1/storage-systems/device-type1/{systemId}/host-sets/{hostSetId}',
                'operation_id': 'device_type1_get_host_sets_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def device_type1_get_all_host_sets(
        ...
        **kwargs
        ...
        >>> thread = api.device_type1_get_all_host_sets(system_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['system_id'] = \
            system_id
        return self.device_type1_get_all_host_sets_endpoint.call_with_http_info(**kwargs)
    ...
    def device_type1_get_host_sets_by_id(
        ...
        **kwargs
        ...
        >>> thread = api.device_type1_get_host_sets_by_id(system_id, host_set_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['host_set_id'] = \
            host_set_id
        return self.device_type1_get_host_sets_by_id_endpoint.call_with_http_info(**kwargs)
