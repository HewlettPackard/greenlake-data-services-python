...
class AuthzApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_access_controls_endpoint = _Endpoint(
            settings={
                'response_type': (AccessControlsResponse,),
                'auth': [
                    'JWTAuth'
                ],
                'endpoint_path': '/api/v1/access-controls',
                'operation_id': 'get_access_controls',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_resource_types_endpoint = _Endpoint(
            settings={
                'response_type': (ResourceTypesResponse,),
                'auth': [
                    'JWTAuth'
                ],
                'endpoint_path': '/api/v1/resource-types',
    ...
    def get_access_controls(
        ...
        **kwargs
        ...
        >>> thread = api.get_access_controls(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_access_controls_endpoint.call_with_http_info(**kwargs)
